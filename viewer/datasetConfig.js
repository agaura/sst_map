const REMOTE_DATASET = 'https://pub-68cd895ae8ad4a04ae416191b982c1eb.r2.dev/mur_sst_cube_global.tif';
...
export async function resolveDatasetUrl({ signal } = {}) {
  ...
  const localUrl = new URL('mur_sst_cube_global.tif', document.baseURI);
  try {
